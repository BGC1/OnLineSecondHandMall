        ...
        var a = r(1),
            s = {
                getProductList: function (e, t, r) {
                    a.request({
                        url: a.getServerUrl("/product/list.do"),
                        data: e,
                        success: t,
                        error: r
                    })
                ...
                getProductDetail: function (e, t, r) {
                    a.request({
                        url: a.getServerUrl("/product/detail.do"),
                        data: {
                            productId: e
                        },
                        success: t,
            ...
            i = {
                data: {
                    listParam: {
                        ...
                        pageSize: a.getUrlParam("pageSize") || 20
                    }
                },
                init: function () {
                    this.onLoad(), this.bindEvent()
