            ...
            n = {
                ...
                bindEvent: function () {
                    ...
                    $("#submit").click(function () {
                        e.submit()
                    }), $(".user-content").keyup(function (r) {
                        13 === r.keyCode && e.submit()
                    })
                },
                submit: function () {
                    var e = {
                        ...
                        r = this.formValidate(e);
                    r.status ? s.login(e, function (e) {
                        window.location.href = o.getUrlParam("redirect") || "./index.html"
                    }, function (e) {
                        u.show(e)
                    }) : u.show(r.msg)
                },
                formValidate: function (e) {
                    ...
                    return o.validate(e.username, "require") ? o.validate(e.password, "require") ? (r.status = !0, r.msg = "验证通过", r) : (r.msg = "密码不能为空", r) : (r.msg = "用户名不能为空", r)
                }
            };
        $(function () {
            n.init()
