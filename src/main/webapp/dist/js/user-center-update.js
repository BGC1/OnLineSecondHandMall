            ...
            u = {
                ...
                bindEvent: function () {
                    ...
                    $(document).on("click", ".btn-submit", function () {
                        var t = {
                            ...
                            r = e.validateForm(t);
                        r.status ? o.updateUserInfo(t, function (e, t) {
                            n.successTips(t), window.location.href = "./user-center.html"
                        }, function (e) {
                            n.errorTips(e)
                        }) : n.errorTips(r.msg)
                    })
                ...
                loadUserInfo: function () {
                    ...
                    o.getUserInfo(function (t) {
                        e = n.renderHtml(i, t), $(".panel-body").html(e)
                    }, function (e) {
                        n.errorTips(e)
                    })
                },
                validateForm: function (e) {
                    ...
                    return n.validate(e.phone, "phone") ? n.validate(e.email, "email") ? n.validate(e.question, "require") ? n.validate(e.answer, "require") ? (t.status = !0, t.msg = "验证通过", t) : (t.msg = "密码提示问题答案不能为空", t) : (t.msg = "密码提示问题不能为空", t) : (t.msg = "邮箱格式不正确", t) : (t.msg = "手机号格式不正确", t)
                }
            };
        $(function () {
            u.init()
