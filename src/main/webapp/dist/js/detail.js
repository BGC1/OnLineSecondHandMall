webpackJsonp([6], {
        ...
        var s = r(1),
            n = {
                getProductList: function (t, e, r) {
                    s.request({
                        url: s.getServerUrl("/product/list.do"),
                        data: t,
                        success: e,
                        error: r
                    })
                ...
                getProductDetail: function (t, e, r) {
                    s.request({
                        url: s.getServerUrl("/product/detail.do"),
                        data: {
                            productId: t
                        },
                        success: e,
    ...
    47: function (t, e, r) {
        ...
        var s = r(1),
            ...
            i = {
                data: {
                    productId: s.getUrlParam("productId") || ""
                },
                init: function () {
                    this.onLoad(), this.bindEvent()
                },
                ...
                bindEvent: function () {
                    ...
                    $(document).on("mouseenter", ".p-img-item", function () {
                        ...
                        var e = $(this).hasClass("plus") ? "plus" : "minus",
                            r = $(".p-count"),
                            s = parseInt(r.val()),
                            n = 1,
                            o = t.data.detailInfo.stock || 1;
                ...
                loadDetail: function () {
                    ...
                    r.html('<div class="loading"></div>'), n.getProductDetail(this.data.productId, function (n) {
                        ...
                        r.html('<p class="err-tip">此商品太淘气，找不到了</p>')
                    })
                },
                filter: function (t) {
