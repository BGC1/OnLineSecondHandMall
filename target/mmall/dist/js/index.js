webpackJsonp([1], [function (t, e, r) {
    ...
    t.exports = '<div class=banner> <ul> <li> <a href="./list.html?categoryId=100021" target=_blank> ' +
        '<img class=banner-img src=' + r(40) + ' /> </a> </li> <li> <a href="./list.html?categoryId=100030" target=_blank> <img class=banner-img src=' + r(41) + ' /> </a> </li> <li> <a href="./list.html?categoryId=100016" target=_blank> <img class=banner-img src=' + r(42) + ' /> </a> </li> <li> <a href="./list.html?categoryId=100001" target=_blank> <img class=banner-img src=' + r(43) + ' /> </a> </li> <li> <a href="./list.html?categoryId=100021" target=_blank> <img class=banner-img src=' + r(44) + ' /> </a> </li> </ul> <div class="banner-arrow prev"> <i class="fa fa-angle-left"></i> </div> <div class="banner-arrow next"> <i class="fa fa-angle-right"></i> </div> </div>'
}, , , , , function (t, e, r) {
    t.exports = r.p + "resource/banner1.jpg"
}, function (t, e, r) {
    t.exports = r.p + "resource/banner2.jpg"
}, function (t, e, r) {
    t.exports = r.p + "resource/banner3.jpg"
}, function (t, e, r) {
    t.exports = r.p + "resource/banner4.jpg"
}, function (t, e, r) {
    t.exports = r.p + "resource/banner5.jpg"
}, , , , function (t, e, r) {
    "use strict";
    r(19), r(7), r(6), r(58);
    var s = (r(11), r(35)),
        n = r(1);
    $(function () {
        var t = n.renderHtml(s);
        $(".banner-con").html(t);
        var e = $(".banner").unslider({
            dots: !0
        });
        ...
        function (t, e) {
            ...
            var r = function () {
                ...
                this.init = function (e, r) {
                    return this.el = e, this.ul = e.children("ul"), this.max = [e.outerWidth(), e.outerHeight()], this.items = this.ul.children("li").each(this.calculate), this.opts = t.extend(this.opts, r), this.setup(), this
                }, this.calculate = function (e) {
                    var s = t(this),
                        n = s.outerWidth(),
                        i = s.outerHeight();
                    r.sizes[e] = [n, i], n > r.max[0] && (r.max[0] = n), i > r.max[1] && (r.max[1] = i)
                }, this.setup = function () {
                    if (this.el.css({
                            overflow: "hidden",
                            width: r.max[0],
                        ...
                        var s = function () {
                            r.el.css("width", Math.min(Math.round(r.el.outerWidth() / r.el.parent().outerWidth() * 100), 100) + "%")
                        };
                        s(), t(window).resize(s)
                    }
                    this.opts.arrows && this.el.parent().append('<p class="arrows"><span class="prev">芒鈥犅�</span><span class="next">芒鈥犫€�</span></p>').find(".arrows span").click(function () {
                        t.isFunction(r[this.className]) && r[this.className]()
                    }), t.event.swipe && this.el.on("swipeleft", r.prev).on("swiperight", r.next)
                }, this.move = function (e, s) {
                    this.items.eq(e).length || (e = 0), 0 > e && (e = this.items.length - 1);
                    var n = this.items.eq(e),
                        i = {
                            height: n.outerHeight()
                        },
                        o = s ? 5 : this.opts.speed;
                    this.ul.is(":animated") || (r.el.find(".dot:eq(" + e + ")").addClass("active").siblings().removeClass("active"), this.el.animate(i, o) && this.ul.animate(t.extend({
                        left: "-" + e + "00%"
                    }, i), o, function () {
                        r.current = e, t.isFunction(r.opts.complete) && !s && r.opts.complete(r.el)
                    }))
                }, this.start = function () {
                    ...
                    return r.interval = clearInterval(r.interval), r
                    ...
                    t.isFunction(n[s]) && n[s]()
                }, this.next = function () {
                    return r.stop().move(r.current + 1)
                }, this.prev = function () {
                    return r.stop().move(r.current - 1)
                }, this.dots = function () {
                    var e = '<ol class="dots">';
