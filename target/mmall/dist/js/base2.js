! function (e) {
    ...
    window.webpackJsonp = function (t, i, a) {
        for (var c, u, l, s = 0, f = []; s < t.length; s++) u = t[s], o[u] && f.push(o[u][0]), o[u] = 0;
        for (c in i) Object.prototype.hasOwnProperty.call(i, c) && (e[c] = i[c]);
        for (n && n(t, i, a); f.length;) f.shift()();
        if (a)
            for (s = 0; s < a.length; s++) l = r(r.s = a[s]);
        return l
    };
    var t = {},
        o = {
    ...
    r.e = function (e) {
        ...
        i.type = "text/javascript", i.charset = "utf-8", i.async = !0, i.timeout = 12e4, r.nc && i.setAttribute("nonce", r.nc), i.src = r.p + "js/" + e + ".js";
    ...
    }, r.p = "//s.happymmall.com/mmall_admin_fe/dist/", r.oe = function (e) {
